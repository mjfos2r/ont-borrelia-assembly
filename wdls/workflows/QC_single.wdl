...
workflow SingleReadsQC {
    ...
    output {
        ...
        File raw_telo_average_depth_txt  = clean_reads_to_ref.average_depth_txt
        String raw_telo_average_depth = clean_reads_to_ref.average_depth
        File raw_telo_average_coverage_txt  = clean_reads_to_ref.average_coverage_txt
        String raw_telo_average_coverage = clean_reads_to_ref.average_coverage
        ...
        File fixed_average_coverage_txt = fixed_reads_to_ref.average_coverage_txt

        File fixed_telo_average_depth_txt  = fixed_reads_to_ref.average_depth_txt
        String fixed_telo_average_depth = fixed_reads_to_ref.average_depth
        File fixed_telo_average_coverage_txt  = fixed_reads_to_ref.average_coverage_txt
        String fixed_telo_average_coverage = fixed_reads_to_ref.average_coverage
